      ...
      <body className="bg-surface text-on-surface font-body selection:bg-primary selection:text-on-primary min-h-screen flex flex-col">
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(){var l=document.createElement('link');l.rel='stylesheet';l.href='https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=add,add_photo_alternate,arrow_forward,autorenew,battery_full,block,bolt,calendar_month,chat,check,check_circle,chevron_left,chevron_right,circle,close,compress,construction,crop_square,dashboard,delete,directions_run,edit,email,error,expand_more,filter_list,grid_4x4,grid_view,handshake,handyman,help_outline,home,image,info,inventory_2,join,lens_blur,light_mode,local_fire_department,local_shipping,location_on,lock,logout,menu,notes,palette,payments,person,phone,public,receipt_long,remove,safety_check,save,scale,schedule,search,settings,shield,shopping_cart,star,storefront,straighten,swap_horiz,texture,thermostat,tune,upload,verified,verified_user,visibility,warning,water,water_drop,wb_cloudy,wb_sunny,zoom_in&display=swap';document.head.appendChild(l);})();`,
          }}
        />
      </body>
    </html>
